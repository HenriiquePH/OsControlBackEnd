package br.unipar.devbackend.oscontrol.InfraSecurity;
...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/peca/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/peca/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/peca/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/servico/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/servico/**").hasRole("ADMIN")
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(); // Uma classe do spring security para fazer as criptografia das senhas
    }
}
